...
create table hospital_management_system.hospitals (
...
create table hospital_management_system.doctors (
doctor_id int primary key,
name varchar(100) not null,
specialty varchar(100) not null,
hospital_id int not null,
email varchar(200),
constraint fk_doctors_hospital foreign key (hospital_id) references hospital_management_system.hospitals(hospital_id)
);

create table hospital_management_system.patients (
...
create table hospital_management_system.appointments (
appointment_id int primary key,
patient_id int not null,
doctor_id int not null,
appointment_date date not null,
reason text,
constraint fk_appointments_patient_id foreign key (patient_id) references hospital_management_system.patients(patient_id),
constraint fk_appointments_doctor_id foreign key (doctor_id) references hospital_management_system.doctors(doctor_id)
);

create table hospital_management_system.departments (
department_id int primary key,
hospital_id int not null,
name varchar(100),
constraint fk_departments_hospitals foreign key (hospital_id) references hospital_management_system.hospitals(hospital_id)
);

create table hospital_management_system.medications (
medication_id int primary key,
name varchar(50) not null,
description text
);

create table hospital_management_system.prescriptions (
prescription_id int primary key,
patient_id int not null,
doctor_id int not null,
medication_id int not null,
prescribed_date date not null,
constraint fk_prescriptions_patient_id foreign key (patient_id) references hospital_management_system.patients(patient_id),
constraint fk_prescriptions_doctor_id foreign key (doctor_id) references hospital_management_system.doctors(doctor_id),
constraint fk_prescriptions_medication_id foreign key (medication_id) references hospital_management_system.medications(medication_id)
);

create table hospital_management_system.rooms  (
room_id int primary key,
room_no varchar(10) not null,
department_id int not null,
capacity int,
constraint fk_rooms_department_id foreign key (department_id) references hospital_management_system.departments(department_id)
);
...
insert into hospital_management_system.hospitals values	
...
insert into hospital_management_system.doctors values
...
insert into hospital_management_system.patients values
...
insert into hospital_management_system.appointments values
...
insert into hospital_management_system.departments values
(1, 1, 'Cardiology'),
(2, 1, 'Radiology'),
(3, 1, 'Oncology'),
(4, 1, 'Pediatrics'),
...
insert into hospital_management_system.medications values
...
insert into hospital_management_system.prescriptions values
...
insert into hospital_management_system.rooms values
(1, '101A', 3, 2),
(2, '101B', 3, 1),
(3, '102', 5, 2),
(4, '103', 5, 4),
